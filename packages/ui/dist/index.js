  ...
  ({ className, label, error, helperText, icon, type = "text", ...props }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "w-full", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "relative", children: [
        icon && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-gray-500 dark:text-gray-400", children: icon }),
      ...
      error && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { id: `${inputId}-error`, className: "mt-1 text-sm text-red-600 dark:text-red-400", children: error }),
      helperText && !error && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { id: `${inputId}-helper`, className: "mt-1 text-sm text-gray-500 dark:text-gray-400", children: helperText })
    ] });
  }
);
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        "div",
        {
          ...
          children: [
            title && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-dark-300", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h2", { id: "modal-title", className: "text-xl font-semibold text-gray-900 dark:text-gray-100", children: title }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "px-6 py-4 max-h-[70vh] overflow-y-auto", children })
          ]
        }
      )
    }
...
var Toast = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    "div",
    {
      ...
      role: "alert",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "p-4", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex items-start", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "flex-shrink-0", children: icons[type] }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "ml-3 flex-1", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "text-sm font-medium", children: title }),
            message && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "mt-1 text-sm opacity-90", children: message })
          ] }),
        ...
        duration > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "absolute bottom-0 left-0 w-full h-1 bg-black/10 dark:bg-white/10", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "div",
          {
...
var ToastContainer = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: cn("fixed z-50 flex flex-col gap-3", positions[position]), children: toasts.map((toast) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Toast, { ...toast }, toast.id)) });
};
