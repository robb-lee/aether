      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Link href="/generate" className="block">
            <button className="w-full flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-6 hover:border-purple-400 hover:bg-purple-50 dark:border-gray-600 dark:hover:border-purple-400 dark:hover:bg-purple-900/20 transition-all">
          ...
          <Link href="/templates" className="block">
            <button className="w-full flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-6 hover:border-blue-400 hover:bg-blue-50 dark:border-gray-600 dark:hover:border-blue-400 dark:hover:bg-blue-900/20 transition-all">
              <div className="text-center">
          ...
          <button className="flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-6 hover:border-gray-400 dark:border-gray-600 dark:hover:border-gray-500 opacity-50 cursor-not-allowed">
            <div className="text-center">
